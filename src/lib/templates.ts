...
export const STARTER_TEMPLATES: StarterTemplate[] = [
	...
	},
	{
		...
		previewBg: '/placeholders/carousel/tweet-cover.png',
		previewText: '',
		previewSource: '',
		badge: 'Tweet',
	...
	},
	{
		...
		studioId: 'blackText',
		name: 'Black text',
		description: 'Centered dark slide with a bright hook line and long body copy',
		href: '/dashboard/studio?template=black-text',
		previewBg: '/placeholders/carousel/black-text-cover.png',
		previewText: '',
		previewSource: '',
		badge: 'Carousel',
