					...
					<div class="platform-card reveal" style="--accent: {p.color}; --delay:{i * 0.07}s">
						<div class="platform-icon-wrap">
							...
							{:else if p.icon === 'reddit'}
								<svg viewBox="0 0 24 24" width="28" height="28" style="color:{p.color}" fill="currentColor" aria-label="Reddit">
							...
							{:else if p.icon === 'pinterest'}
								<svg viewBox="0 0 24 24" width="28" height="28" style="color:{p.color}" fill="currentColor" aria-label="Pinterest">
							...
							{:else if p.icon === 'threads'}
								<svg viewBox="0 0 24 24" width="28" height="28" style="color:#111" fill="currentColor" aria-label="Threads">
							...
							{:else if p.icon === 'snapchat'}
								<svg viewBox="0 0 24 24" width="28" height="28" style="color:#111" fill="currentColor" aria-label="Snapchat">
							...
							{:else if p.icon === 'bluesky'}
								<svg viewBox="0 0 24 24" width="28" height="28" style="color:{p.color}" fill="currentColor" aria-label="Bluesky">
									<path d="M5.202 2.857C7.954 4.922 10.913 9.11 12 11.358c1.087-2.247 4.046-6.436 6.798-8.501C20.783 1.366 24 .213 24 3.883c0 .732-.42 6.156-.667 7.037-.856 3.061-3.978 3.842-6.755 3.37 4.854.826 6.089 3.562 3.422 6.299-5.065 5.196-7.28-1.304-7.847-2.97-.104-.305-.152-.448-.153-.327 0-.121-.05.022-.153.327-.568 1.666-2.782 8.166-7.847 2.97-2.667-2.737-1.432-5.473 3.422-6.3-2.777.473-5.899-.308-6.755-3.369C.42 10.04 0 4.615 0 3.883c0-3.67 3.217-2.517 5.202-1.026"/>
								</svg>
							{:else}
								<div class="platform-fallback" style="--accent:{p.color}">
...
.section-light .platform-card {
	...
	border-color: rgba(10,5,5,0.10);
}
.section-light .platform-card:hover { border-color: rgba(10,5,5,0.16); }
.section-light .platform-name { color: rgba(10,5,5,0.55); }
